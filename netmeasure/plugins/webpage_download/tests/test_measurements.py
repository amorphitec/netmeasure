...
from netmeasure.plugins.latency.measurements import LatencyMeasurement
from netmeasure.results import Error
from netmeasure.plugins.webpage_download.measurements import WebpageMeasurement
from netmeasure.plugins.webpage_download.measurements import WEB_ERRORS

from netmeasure.plugins.webpage_download.results import WebpageMeasurementResult
...
class WebpageMeasurementResultsTestCase(TestCase):
    ...
    @mock.patch(
        "netmeasure.plugins.webpage_download.measurements.WebpageMeasurement._get_webpage_result"
    )
    ...
    @mock.patch(
        "netmeasure.plugins.webpage_download.measurements.WebpageMeasurement._download_assets"
    )
    @mock.patch(
        "netmeasure.plugins.webpage_download.measurements.WebpageMeasurement._parse_html"
    )
