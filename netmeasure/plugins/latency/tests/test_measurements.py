...
from netmeasure.plugins.latency.measurements import LatencyMeasurement, LATENCY_ERRORS
from netmeasure.plugins.latency.results import (
        ...
        self.assertEqual(
            [
                ...
                LatencyIndividualMeasurementResult(
                    ...
                    host="validfakehost.com",
                    packet_size="64",
                    packet_size_unit=StorageUnit.byte,
