...
from netmeasure.plugins.netflix_fast.measurements import (
...
from netmeasure.plugins.netflix_fast.results import (
    NetflixFastMeasurementResult,
    NetflixFastThreadResult,
)
from netmeasure.plugins.latency.results import LatencyMeasurementResult
from netmeasure.results import Error
...
class NetflixResultTestCase(TestCase):
    ...
    @mock.patch(
        "netmeasure.plugins.netflix_fast.measurements.NetflixFastMeasurement._get_fast_result"
    )
    @mock.patch(
        "netmeasure.plugins.netflix_fast.measurements.NetflixFastMeasurement._get_url_result"
    )
    ...
    @mock.patch(
        "netmeasure.plugins.netflix_fast.measurements.NetflixFastMeasurement._manage_threads"
    )
    @mock.patch(
        "netmeasure.plugins.netflix_fast.measurements.NetflixFastMeasurement._get_connection"
    )
    ...
    @mock.patch(
        "netmeasure.plugins.netflix_fast.measurements.NetflixFastMeasurement._query_api"
    )
    @mock.patch("requests.Session")
    ...
    @mock.patch(
        "netmeasure.plugins.netflix_fast.measurements.NetflixFastMeasurement._is_stabilised"
    )
    ...
    @mock.patch("netmeasure.plugins.latency.measurements.LatencyMeasurement.measure")
